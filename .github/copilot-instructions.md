...
This is the official Datum Inc. marketing website - an Astro-based static site with SSR capabilities, built with TypeScript, Tailwind CSS v4, and AlpineJS. The site serves multiple purposes: marketing pages, documentation (via Mintlify), blog, handbook, changelog, and interactive features like roadmap voting.

**Tech Stack:** Astro 5, TypeScript, Tailwind CSS v4, AlpineJS, Mintlify, Postgres, MDX
...
- **Loaders:** Content uses `glob` loaders, docs use `docsLoader()` from Mintlify
