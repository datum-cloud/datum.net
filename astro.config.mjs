...
export default defineConfig({
  ...
  redirects: {
    ...
    '/download': '/docs/desktop-apps',
    '/downloads': '/docs/desktop-apps',
    '/download/mac-os': '/docs/desktop-apps',
    '/downloads/mac-os': '/docs/desktop-apps',
    '/download/windows': '/docs/desktop-apps',
    '/downloads/windows': '/docs/desktop-apps',
    '/download/linux': '/docs/desktop-apps',
    '/downloads/linux': '/docs/desktop-apps',
    '/download/datumctl': '/docs/datumctl/quickstart',
    '/downloads/datumctl': '/docs/datumctl/quickstart',
    '/download/datum-mcp': '/docs/datum-mcp',
    '/downloads/datum-mcp': '/docs/datum-mcp',
    '/download/go': '/docs',
    '/downloads/go': '/docs',
    '/download/rust': '/docs',
    '/downloads/rust': '/docs',
    '/download/typescript': '/docs',
    '/downloads/typescript': '/docs',
  },
  security: {
    checkOrigin: false,
  },
  ...
  integrations: [
    ...
    announcement({
      show: true,
      label: 'Explore Datum',
      text: 'Take your localhost global with our alpha desktop app',
      href: '/docs/desktop-apps',
      icon: {
        name: 'arrow-right',
        size: 'sm',
      },
