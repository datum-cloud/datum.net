...
const REDIRECTS = {
  ...
  '/jobs/': { destination: '/careers', status: 301 },
  '/community-huddle/': { destination: '/events', status: 301 },
  '/handbook/engineering/rfc/': { destination: '/handbook/build', status: 301 },
  '/handbook/company/what-we-believe/': { destination: '/handbook/about/purpose', status: 301 },
  ...
  '/handbook/people/travel-policy/': { destination: '/handbook/operate/traveling', status: 301 },
  '/handbook/company/where-are-we-now/': { destination: '/handbook/about/strategy', status: 301 },
  ...
  '/terms-of-service/': { destination: '/legal/terms', status: 301 },
  '/index.asp': { destination: '/', status: 301 },
  '/logon.html': { destination: `${AUTH_TARGET}/ui/v2/login/loginname`, status: 301 },
  '/public-slack/': { destination: 'https://link.datum.net/discord', status: 301 },
  '/handbook/company/': { destination: '/handbook/about', status: 301 },
  '/handbook/engineering/': { destination: '/handbook/build', status: 301 },
  '/handbook/go-to-market/': { destination: '/handbook/about', status: 301 },
  // Application downloads now live in the documentation site. Keep both the
  // old singular and plural URLs working for bookmarks and search results.
  '/download': { destination: '/docs/desktop-apps', status: 301 },
  '/download/': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/': { destination: '/docs/desktop-apps', status: 301 },
  '/download/mac-os': { destination: '/docs/desktop-apps', status: 301 },
  '/download/mac-os/': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/mac-os': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/mac-os/': { destination: '/docs/desktop-apps', status: 301 },
  '/download/windows': { destination: '/docs/desktop-apps', status: 301 },
  '/download/windows/': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/windows': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/windows/': { destination: '/docs/desktop-apps', status: 301 },
  '/download/linux': { destination: '/docs/desktop-apps', status: 301 },
  '/download/linux/': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/linux': { destination: '/docs/desktop-apps', status: 301 },
  '/downloads/linux/': { destination: '/docs/desktop-apps', status: 301 },
  '/download/datumctl': { destination: '/docs/datumctl/quickstart', status: 301 },
  '/download/datumctl/': { destination: '/docs/datumctl/quickstart', status: 301 },
  '/downloads/datumctl': { destination: '/docs/datumctl/quickstart', status: 301 },
  '/downloads/datumctl/': { destination: '/docs/datumctl/quickstart', status: 301 },
  '/download/datum-mcp': { destination: '/docs/datum-mcp', status: 301 },
  '/download/datum-mcp/': { destination: '/docs/datum-mcp', status: 301 },
  '/downloads/datum-mcp': { destination: '/docs/datum-mcp', status: 301 },
  '/downloads/datum-mcp/': { destination: '/docs/datum-mcp', status: 301 },
  '/download/go': { destination: '/docs', status: 301 },
  '/download/go/': { destination: '/docs', status: 301 },
  '/downloads/go': { destination: '/docs', status: 301 },
  '/downloads/go/': { destination: '/docs', status: 301 },
  '/download/rust': { destination: '/docs', status: 301 },
  '/download/rust/': { destination: '/docs', status: 301 },
  '/downloads/rust': { destination: '/docs', status: 301 },
  '/downloads/rust/': { destination: '/docs', status: 301 },
  '/download/typescript': { destination: '/docs', status: 301 },
  '/download/typescript/': { destination: '/docs', status: 301 },
  '/downloads/typescript': { destination: '/docs', status: 301 },
  '/downloads/typescript/': { destination: '/docs', status: 301 },
  '/resources/changelog/': { destination: '/changelog', status: 301 },
  '/resources/roadmap/': { destination: '/roadmap', status: 301 },
  '/resources/open-source/': { destination: '/open-source', status: 301 },

  // Site page aliases
  '/about-us': { destination: '/about', status: 301 },
  '/about-us/': { destination: '/about', status: 301 },
  '/team/': { destination: '/about', status: 301 },
  '/leadership': { destination: '/about', status: 301 },
  '/leadership/': { destination: '/about', status: 301 },
  '/jobs': { destination: '/careers', status: 301 },
  '/feature': { destination: '/platform/deliver', status: 301 },
  '/products': { destination: '/platform/deliver', status: 301 },
  '/products/': { destination: '/platform/deliver', status: 301 },
  '/product/vpc': { destination: '/platform/deliver', status: 301 },
  '/features.md': { destination: '/platform/deliver.md', status: 301 },
  ...
  '/features/connect/': { destination: '/platform/connect', status: 301 },
  '/design': { destination: '/brand', status: 301 },
  '/design/': { destination: '/brand', status: 301 },
  '/support': { destination: '/contact', status: 301 },
  '/support/': { destination: '/contact', status: 301 },
  '/overview/datum': { destination: '/docs/overview/why-datum', status: 301 },
  '/overview/datum/': { destination: '/docs/overview/why-datum', status: 301 },
  ...
  '/privacy': { destination: '/legal/privacy', status: 301 },
  '/terms-of-service': { destination: '/legal/terms', status: 301 },
  '/legal/privacy-policy': { destination: '/legal/privacy', status: 301 },
  '/legal/privacy-policy/': { destination: '/legal/privacy', status: 301 },
  '/legal/pricavy': { destination: '/legal/privacy', status: 301 },
  '/legal/pricavy/': { destination: '/legal/privacy', status: 301 },
  '/legal/term': { destination: '/legal/terms', status: 301 },
  '/legal/term/': { destination: '/legal/terms', status: 301 },
  '/legal/trust': { destination: '/legal/privacy', status: 301 },
  '/legal/trust/': { destination: '/legal/privacy', status: 301 },
  '/legal/security': { destination: '/docs/overview/support', status: 301 },
  '/legal/security/': { destination: '/docs/overview/support', status: 301 },
};
...
const PREFIX_REDIRECTS = [
  { from: '/handbook/technical/', to: '/handbook/build/', status: 301 },
  { from: '/handbook/culture/', to: '/handbook/operate/', status: 301 },
];
