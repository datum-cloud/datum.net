...
const REDIRECTS = {
  ...
  '/jobs': { destination: '/careers', status: 302 },
  '/feature': { destination: '/platform/deliver', status: 302 },
  '/products': { destination: '/platform/deliver', status: 302 },
  '/products/': { destination: '/platform/deliver', status: 302 },
  '/product/vpc': { destination: '/platform/deliver', status: 302 },
  '/features.md': { destination: '/platform/deliver.md', status: 302 },
  '/platform': { destination: '/platform/deliver', status: 302 },
  '/platform/': { destination: '/platform/deliver', status: 302 },
  '/features': { destination: '/platform/deliver', status: 302 },
  '/features/': { destination: '/platform/deliver', status: 302 },
  '/features/build': { destination: '/platform/build', status: 302 },
  '/features/build/': { destination: '/platform/build', status: 302 },
  '/features/connect': { destination: '/platform/connect', status: 302 },
  '/features/connect/': { destination: '/platform/connect', status: 302 },
