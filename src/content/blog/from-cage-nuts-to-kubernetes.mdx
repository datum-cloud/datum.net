...
In my role as co-founder and CTO at Dynamic Network Services (DynDNS.org), I was sometimes able to get out into the field to help deploy new infrastructure. Getting into the datacenter is a chance to connect a virtual world to the physical world - concrete floors, tilt up slabs, plumbing, power, cooling, and of course, fiber optics. For me, that time in the datacenter is a welcome relief from the desk jockeying that precedes in bringing a new POP online.

![alt text](assets/images/from-cage-1.jpg)
Image: DynECT Managed DNS deployment at Equinix AM2; June 2008
...
![alt text](assets/images/from-cage-2.jpg)
Image: DynDNS Offices, DynECT Managed DNS Newark NJ Core POP - Staged for Shipment by Van; February 2009
...
![alt text](assets/images/from-cage-3.png)
Image: ARIN Routing Security Dashboard, November 2025
...
![alt text](assets/images/from-cage-4.png)
Image: Domains as a Datum K8s Resource Definition, November 2025
