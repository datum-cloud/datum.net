...
<Figure title="DynECT Managed DNS deployment at Equinix AM2; June 2008" align="right">![A rack filled with dozen servers](./assets/images/from-cage-1.jpg)</Figure>
...
<Figure title="DynDNS Offices, DynECT Managed DNS Newark NJ Core POP - Staged for Shipment by Van; February 2009">![Piled boxes of network tools inside office](./assets/images/from-cage-2.jpg)</Figure>
...
<Figure title="Routing security dashboard UI">![A screenshot of Routing Security Dashboard. A table showing eligibility of Internet Routing Registry (IRR) and Resource Public Key Infrastructure (RPKI).](./assets/images/from-cage-3.jpg)</Figure>
...
<Figure title="Domains as a Datum K8s Resource Definition, November 2025">![A screenshot showing table of domain names as K8s resource definition in Datum system](./assets/images/from-cage-4.jpg)</Figure>
