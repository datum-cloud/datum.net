...
<Figure title="Routing security dashboard UI">![Piled boxes of network tools inside office](./assets/images/from-cage-3.png)</Figure>
...
<Figure title="Domains as a Datum K8s Resource Definition, November 2025">![Domain as Datum K8s resource definition](/src/content/blog/assets/images/from-cage-4.png)</Figure>
