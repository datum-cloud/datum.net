...
draft: false
meta:
  title: "Meet Olli: The Design Framework Behind Datum"
  description: "A design framework built to improve consistency, remove friction and drive UX and UI decisions for our open network cloud and interconnection services."
  og:
    title: Why today’s builders need internet superpowers
    description: The shared foundation that improves consistency, removes friction, and lets us build new ideas quickly without constraining creativity.
    image: assets/images/olli-social.png
---
...
<Figure title="The Olli variables.">![A screenshot taken from Figma showing variables of text sizes, line heights, letter spacing, spacing scale](./assets/images/olli-3.png)</Figure>
