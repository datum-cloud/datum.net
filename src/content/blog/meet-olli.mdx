...
thumbnail: assets/images/blog-6.png
featuredImage: assets/images/blog-6.png
...
meta:
  ...
  og:
    ...
    description: The shared foundation that improves consistency, removes friction, and lets us build new ideas quickly without constraining creativity.
    image: assets/images/olli-1.png
---
...
<Figure title="Our Olli mascot!">![Our Olli mascot!](./assets/images/olli-1.png)</Figure>
...
<Figure title="The Olli variables of text sizes, line heights, letter spacing, spacing scale.">![A screenshot taken from Figma showing variables of text sizes, line heights, letter spacing, spacing scale](./assets/images/olli-3.png)</Figure>
