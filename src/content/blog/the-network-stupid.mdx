...
meta:
  ...
  description: Why we're building an ecosystem-focused infrastructure cloud.
  og:
    title: It’s the network, stupid - Datum Cloud Networking Blog
---
...
As you can probably tell, we're passionate about connecting others. If you're interested to learn more, please [reach out](/public-slack) or get involved on [GitHub](https://github.com/datum-cloud).
