...
sidebar:
  order: 3
meta:
  title: "API Auth Guide - Datum Docs for Bearer Token Exchange & Error Handling"
  description: "Learn how to authenticate with Datum Cloud API using short-lived bearer tokens. Follow instructions for generating personal access tokens, exchanging for API tokens, refreshing hourly, and handling authentication errors like 403 Forbidden."
---
