...
sidebar:
  order: 2
meta:
  title: "Datum API Connection Guide - Control Planes, Organizational & Project APIs"
  description: "Learn how to connect to Datum Cloud APIs and interact with organizational and project control planes to manage resources. Explore base URLs, control plane functions, API discovery, and access OpenAPI specs for effective system integration."
---
...
:::tip[Tip]
The above command expects you've [setup the Datum CLI](/docs/quickstart/datumctl/)
:::
