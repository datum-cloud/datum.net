...
sidebar:
  order: 1
meta:
  title: "Datum Cloud API Reference: Network Infrastructure Solutions & Cloud Native AI"
  description: "Access the declarative Datum Cloud API to create and manage services with advanced Edge Networking capabilities. Leverage Kubernetes Custom Resources for cloud native ai and infrastructure using the open source cloud approach."
---
