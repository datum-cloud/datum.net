...
sidebar:
  order: 4
meta:
  title: "Datum API Reference: Kubernetes CRDs"
  description: "Detailed API reference for the Datum Cloud Control Plane, exposing Kubernetes Custom Resources for managing IAM, networking, and telemetry. Explore the declarative platform for building cloud native ai and advanced Edge Networking solutions."
---
