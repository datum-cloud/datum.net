---
title: "datumctl create clusterrole"
---
## datumctl create clusterrole
...
```
datumctl create clusterrole NAME --verb=verb --resource=resource.group [--resource-name=resourcename] [--dry-run=server|client|none]
```
