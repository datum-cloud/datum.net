---
title: "datumctl create configmap"
---
## datumctl create configmap
...
```
datumctl create configmap NAME [--from-file=[key=]source] [--from-literal=key1=value1] [--dry-run=server|client|none]
```
