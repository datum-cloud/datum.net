---
title: "datumctl create poddisruptionbudget"
---
## datumctl create poddisruptionbudget
...
```
datumctl create poddisruptionbudget NAME --selector=SELECTOR --min-available=N [--dry-run=server|client|none]
```
