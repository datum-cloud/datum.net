---
title: "datumctl create priorityclass"
---
## datumctl create priorityclass
...
```
datumctl create priorityclass NAME --value=VALUE --global-default=BOOL [--dry-run=server|client|none]
```
