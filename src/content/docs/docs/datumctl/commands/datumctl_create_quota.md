---
title: "datumctl create quota"
---
## datumctl create quota
...
```
datumctl create quota NAME [--hard=key1=value1,key2=value2] [--scopes=Scope1,Scope2] [--dry-run=server|client|none]
```
