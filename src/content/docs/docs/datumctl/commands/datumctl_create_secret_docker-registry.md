---
title: "datumctl create secret docker-registry"
---
## datumctl create secret docker-registry
...
```
datumctl create secret docker-registry NAME --docker-username=user --docker-password=password --docker-email=email [--docker-server=string] [--from-file=[key=]source] [--dry-run=server|client|none]
```
