---
title: "datumctl create secret generic"
---
## datumctl create secret generic
...
```
datumctl create secret generic NAME [--type=string] [--from-file=[key=]source] [--from-literal=key1=value1] [--dry-run=server|client|none]
```
