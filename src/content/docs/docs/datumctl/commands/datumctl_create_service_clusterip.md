---
title: "datumctl create service clusterip"
---
## datumctl create service clusterip
...
```
datumctl create service clusterip NAME [--tcp=<port>:<targetPort>] [--dry-run=server|client|none]
```
