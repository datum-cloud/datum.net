---
title: "datumctl create service externalname"
---
## datumctl create service externalname
...
```
datumctl create service externalname NAME --external-name external.name [--dry-run=server|client|none]
```
