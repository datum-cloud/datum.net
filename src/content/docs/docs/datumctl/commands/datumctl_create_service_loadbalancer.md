---
title: "datumctl create service loadbalancer"
---
## datumctl create service loadbalancer
...
```
datumctl create service loadbalancer NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
