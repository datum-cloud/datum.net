---
title: "datumctl create service nodeport"
---
## datumctl create service nodeport
...
```
datumctl create service nodeport NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
