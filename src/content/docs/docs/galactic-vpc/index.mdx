...
sidebar:
  order: 1
meta:
  title: "Galactic VPC Installation Guide - Datum Kubernetes Overlay Setup"
  description: "Step-by-step instructions for installing Galactic VPC on Kubernetes - covering host and network requirements, VRF modules, SRv6 loopback, CNI and Multus plugins, agent configuration, MQTT setup, and firewall rules for overlay networking."
---
