...
sidebar:
  order: 1
meta:
  title: "Datum Virtual Private Cloud - Galactic VPC"
  description: "Build a global, private backbone in minutes. Galactic VPC provides secure cloud interconnect and policy-controlled routing across all your providers."
---
