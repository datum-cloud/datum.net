...
[Here](https://github.com/datum-cloud/galactic-agent/blob/main/config/base/daemonset.yaml) is an example Kubernetes 
...
[Here](https://github.com/datum-cloud/galactic-router/blob/main/config/base/deployment.yaml) is an example `Deployment` 
