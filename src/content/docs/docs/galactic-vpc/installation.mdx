...
Below is an example `Deployment` manifest you can use. To make this work, you must 
provide [configuration](https://github.com/datum-cloud/galactic-router/blob/main/galactic_router/__init__.py#L19) 
for the database and MQTT connection. You can provide this configuration as command arguments or environment variables.
