...
Galactic consists of several [components](/docs/galactic-vpc/#components) that work together to provide its
full functionality.
...
described in our [naming and numbering section](/docs/galactic-vpc/naming-numbering/#srv6-addressing).
