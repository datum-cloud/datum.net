...
sidebar:
  order: 3
meta:
  title: "Galactic VPC Naming Guide - SRv6 Addressing, Interface & MTU Principles"
  description: "Learn about Galactic VPC’s naming and numbering principles, including SRv6 IPv6 addressing schemes, network interface naming conventions, MTU calculations, and design patterns for global and internal deployment. Ideal for platform engineers and operators."
---
