...
sidebar:
  order: 8
meta:
  title: "Datum Network Cloud Glossary - Terms for Infrastructure & Platform Users"
  description: "Explore Datum Cloud’s glossary for definitions of key terms in cloud networking, Kubernetes, and infrastructure management. Learn about resource types, networking concepts, automation, placement, scaling, service chaining, and more."
---
