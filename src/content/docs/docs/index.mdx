...
sidebar:
  order: 0
meta:
  title: "Datum Documentation: Open Cloud Platform for AI Workloads"
  description: "Get started with Datum Cloud, Network, and Open Source Kubernetes tooling. Deploy network workloads anywhere and connect your applications programmatically."
---
