...
meta:
  ...
  description: "Get started with Datum Cloud, and connect your AI workloads and apps programmatically with your unique ecosystems globally."
  og:
    title: Get up and running quickly with Datum
    description: The world's first truly netural open network cloud
---
...
## Key Capabilities & Open Features
...
- We run a global anycast network in global locations
- Our code is backed by permissive AGPLv3 open source licenses

## Tiers, Business Model, and Origin
