...
head:
  - tag: meta
    attrs:
      name: title
      content: Overview | Datum Documentation
  - tag: meta
    attrs:
      name: description
      content: Get up and running quickly across our Datum Cloud Platform, programmatic global network and open source tooling.
  - tag: meta
    attrs:
      property: og:title
      content: Overview | Datum Documentation
  - tag: meta
    attrs:
      ...
      content: Get started with our open source alternative cloud for AI.
  - tag: meta
    attrs:
      property: og:image
      content: /images/og-doc.png
---
