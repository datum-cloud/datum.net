...
sidebar:
  order: 2
meta:
  title: "Global Network Locations - Datum Zones & Regions"
  description: "Deploy anywhere. Explore the Datum global network map, including managed regions and federated zones for your open network cloud infrastructure."
---
