...
sidebar:
  order: 2
meta:
  title: "Join the Datum Platform - Access Our Cloud Network Tools"
  description: "Create your Datum account in seconds. Sign up with Google or GitHub to access our free Builder tier and start managing your open network cloud."
---
