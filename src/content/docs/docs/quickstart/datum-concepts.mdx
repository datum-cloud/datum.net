...
**Locations** - We deploy infrastructure in the top internet aggregation points globally. To learn more about how we translate that infrastructure into customer-facing regions and zones, check out the [Infrastructure](/docs/infrastructure/) section later in these docs.
