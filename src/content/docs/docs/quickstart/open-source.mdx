...
sidebar:
  order: 4
meta:
  title: "Datum Open Source Strategy - AGPLv3 & Licensing"
  description: "Understand Datum's open source strategy. Read about our AGPLv3 licensing philosophy, transparency commitments, and how to contribute to the open network cloud."
---
