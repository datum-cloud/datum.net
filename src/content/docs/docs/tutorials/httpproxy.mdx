...
- [Installed and configured the necessary tools](../tasks/tools.md)
- [Created a Datum project](../tasks/create-project/)
- [Configured a kubeconfig context for your project](../tasks/create-project/#add-a-kubeconfig-context-for-your-project)
...
- [Export telemetry to Grafana Cloud](./grafana/)
