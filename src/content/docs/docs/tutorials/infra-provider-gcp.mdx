...
meta:
  title: "Create a Datum Workload backed by Google Cloud (GCP)"
  description: "Follow this tutorial to deploy a Datum Workload backed by Google Cloud (GCP). Learn to configure IAM roles, register a managed location, and create network and workload resources"
---
