...
description: "This tutorial assumes you have already"
---
...
[installed and configured the necessary tools] to
interact with Datum, and have [created a Datum project].
...
xThese actions will result in billable resources being created in the GCP
