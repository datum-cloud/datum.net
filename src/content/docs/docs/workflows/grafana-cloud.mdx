...
sidebar:
  order: 2
meta:
  title: "How to Export Datum Platform Data to Grafana Cloud | Metrics Integration Guide"
  description: "Learn how to export metrics from your Datum platform to Grafana Cloud. This tutorial covers step-by-step configuration, creating Secrets and ExportPolicy resources, and troubleshooting for seamless cloud telemetry integration."
---
