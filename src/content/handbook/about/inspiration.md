---
title: Four key trends
sidebar:
  label: Four key trends
  order: 3
...
4. **The need for a neutral operator**: Over the last cycle, public clouds were joined by an exploding cohort of “alt clouds” that provide specific value “as a service” around data, security, developer experiences, AI infrastructure, inference, etc. These modern service providers (alongside incumbent technology producers and digital-leading enterprises) need a neutral, programmatic platform that sits in between all of the clouds, networks, and enterprises. A virtual “meet me room” for an AI and data first world.

Enter Datum, the world’s first truly open network cloud — built by industry veterans to be a neutral place where AI native providers, tech incumbents, and digital leaders can programmatically interact with their unique ecosystem.