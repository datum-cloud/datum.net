...
Part of your job as an employee of Datum is to help us responsibly spend our money. 

The most important thing is that you act like an owner. While we aim to be cost-efficient and purposeful with our resources, we also need to avoid being “penny wise, pound foolish.” In other words, please spend money in a way that you think is in the best interests of the company.
...
- For subscriptions, you can [use a virtual card](https://support.ramp.com/hc/en-us/articles/360051208534-How-to-use-Ramp-funds-physical-cards-and-virtual-cards#01K8K32499QAZ74YDFFWEX4WS6) and assign your subscriptions to that virtual card so all those charges will come from that spend limit and not your default card limit.
...
- Please do not upload cropped images that show just the amount. It must be an itemized receipt in order for the system to accept it. 
...
- The company gets rewards for all spending on Ramp, which adds up over time. We also can't process lots of reimbursement requests for people looking to get their own points.

- If you can't use your Ramp card for some reason, ask Steve to purchase on his. 

- If you do need to use your personal card, please use the request reimbursement function in Ramp, and provide full context on what the expense is for, and why you didn't use your Ramp.

Personal expenses should be submitted within 60 days of incurring the expense, otherwise these will not be repaid.

Accidentally bought something on the company card when it was a personal expense? Tried changing the payment method with the merchant and it's too late? Don't worry! If you used your Ramp card you can login to Ramp, find the charge and use the repay function - see the [Ramp employee repayments guide](https://support.ramp.com/hc/en-us/articles/4617080010259-Employee-repayments) for details. 
...
We are strongly opposed to introducing new collaboration software, and we’ll ask you to justify it with a meaningful process if you see the upside. This is because introducing new collaborative software creates another place where tasks and conversations can exist. 
...
Individual software is down to your personal preference, and we encourage you to share stuff that you find useful. Each person has $100 per month for individual software use. Anything that has one or more other people using it should have its own shared budget (just request this in Ramp using the “[shared card](https://support.ramp.com/hc/en-us/articles/27036901009043-Shared-cards-funds-for-tracking-group-spend#h_01HR5QC82VT2G0MJ58ZSK679GJ)” feature).

## AI tools

This is expected to be a dedicated monthly budget to help you enhance your work productivity and empower you to ship faster. This budget of USD $300 per month for Engineers and is separate from your regular software subscription. It is meant for work related tools only, such as AI coding assistants, API credits, and other AI tool subscriptions.
...
- Before then, if you wish to spend up to $200 on an IDE, that is fine. Our team uses the whole landscape of tools, most of which are free: VSCode, Zed, Cursor, Emacs, Neovim, et al.

## Work space

We care about you being healthy, happy and productive.

While Datum uses the money saved from not having lots of offices to invest in real life meetups, we are happy to cover some expenses related to where you work. Most people do most of their work from home, but we understand that getting out of the house from time to time can help you escape cabin fever!

You can spend up to $200/month to work in cafés or coworking spaces. You must provide receipts if applicable, and in this case, they must only be for yourself. If your workspace is over $200, please pay for this yourself and request a reimbursement through Ramp for the $200 per month.
...
As a global team, we don't get many regular opportunities to work with each other or socialize outside of offsites. However, we strongly encourage project / product / functional team members to try and work together in person when practical. As such we provide everyone with a $1500 quarterly budget to cover the cost of travel, accommodation, and meals. This budget is in addition to things like in-person onboarding and full or department team offsites. Any unused budget does not roll over into the next quarter.
