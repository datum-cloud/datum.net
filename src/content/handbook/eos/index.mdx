...
meta:
  ...
  description: "Datum runs on the Entrepreneurial Operating System (EOS) — learn the core elements, from Vision/Traction Organizers to Rocks, that shape how we work."
  og:
      title: "Why We Use EOS (Entrepreneurial Operating System)"
