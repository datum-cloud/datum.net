...
## Scope
This policy applies to the data assets associated with customer accounts that are processed by Datum in connection with providing the Datum Solution.

## Schedule
Datum should review the data it retains as part of reviewing its data register at least annually.
...
| :--- | :--- |
| Customer account and live production data* | Duration of contract |
...
_Datum acts as the data processor for this information pursuant to our DPA. In all other cases, Datum acts as the data controller._
