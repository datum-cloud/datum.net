...
In order to detect potential vulnerabilities, the Security Team:
...
* Reviews dependencies for security patches prior to new builds for software that Datum ships.
