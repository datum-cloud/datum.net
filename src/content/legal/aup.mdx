...
meta:
  ...
  description: "Datum's Acceptable Use Policy governs Customer's use of the Datum Cloud Service and describes rules that apply to any party using any products and services provided by Datum Technology, Inc."
  og:
    title: "Acceptable Use Policy - Datum Cloud"
---
