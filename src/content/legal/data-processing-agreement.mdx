...
meta:
  ...
  description: "Read the Data Processing Agreement covering roles, security, sub-processors, transfers, and data subject rights."
  og:
    title: "Data Processing Agreement - Datum Cloud"
---
...
| Element | Details |
| :---- | :---- |
| **Controller** | Customer (as identified in the MSA cover page, or, where no cover page has been executed, as registered on Customer's Datum account) |
