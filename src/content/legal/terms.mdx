...
meta:
  ...
  description: "Read the Datum Terms of Service — the legal agreement governing your access to our open network cloud, covering account responsibilities and use terms."
  og:
...
<small class="mb-8 block italic">Last Updated: December 1, 2024</small>
...
**Acceptable Use:** Customer's use of the Cloud Service is subject to Datum's Acceptable Use Policy ("AUP"), available at [datum.net/legal/aup](https://www.datum.net/legal/aup/), which is incorporated into this Agreement by reference. In the event of a conflict between this Agreement and the AUP, the AUP will control with respect to matters of acceptable use.
