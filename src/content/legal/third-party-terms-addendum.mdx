---
title: "Third-Party Terms Addendum"
slug: third-party-terms-addendum
sidebar:
  label: "Third-Party Terms Addendum"
  order: 10
description: "Datum's Third-Party Terms Addendum sets out pass-through obligations for third-party software incorporated into the Datum platform."
meta:
  title: "Third-Party Terms Addendum - Datum Cloud"
  description: "Read the Third-Party Terms Addendum covering license scope, customer obligations, audit rights, and upstream software terms."
  og:
    title: "Third-Party Terms Addendum - Datum Cloud"
---
...
<small class="mb-2 block italic">Version 1.0 · August 10, 2026</small>

<small class="mb-8 block italic">Draft: This is a working draft. Vendor-specific obligations in Schedule A are placeholders pending execution of Datum's reseller and partner agreements. All bracketed text requires completion before execution.</small>

This Third-Party Terms Addendum ("Addendum") is incorporated into and forms part of the Master Services Agreement ("MSA") between Datum Technology, Inc. ("Datum") and the customer executing the MSA ("Customer"). Capitalized terms not defined herein have the meanings given in the MSA. In the event of any conflict between this Addendum and the MSA, this Addendum controls with respect to Third-Party Software.
