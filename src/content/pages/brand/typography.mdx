...
title: Typography
meta:
  title: "Datum Design - Typography"
  description: Typography guidelines and font specifications for the Datum brand system.
---
...
<Container tag="section" class="space-y-12 max-w-none lg:mt-16 md:mt-12 mt-8 lg:mb-30 md:mb-22 mb-16">
  ...
  target="_blank"
  href="https://drive.google.com/drive/folders/1NtC4FxZgXb2EG89KydRua8sIBsBVmcrs?usp=drive_link"
  />
