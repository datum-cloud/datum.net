...
const server = import.meta.env.AUTH_OIDC_ISSUER;
const clientId = import.meta.env.AUTH_OIDC_CLIENT_ID || '';
const clientSecret = import.meta.env.AUTH_OIDC_CLIENT_SECRET || '';
const redirect_uri = import.meta.env.AUTH_OIDC_REDIRECT_URI;
