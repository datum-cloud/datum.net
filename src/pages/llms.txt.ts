...
export const GET: APIRoute = async () => {
  try {
    ...
    llmsContent += `\n## Developers\n\n`;
    llmsContent += `- [Datum Developer Resources](${siteUrl}/developers) - index of every developer-facing resource Datum publishes (OpenAPI spec, auth docs, MCP server, CLI, rate limits, changelog, status), at predictable URLs.\n`;
