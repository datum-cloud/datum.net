  ...
  return (
    <div className="relative">
      <textarea
        ...
        rows={2}
        className={cn(
          'w-full resize-none rounded-xl py-3 pr-10 pl-3 outline-none',
          isMobile ? 'text-base' : 'text-sm',
          'border border-gray-200',
          'bg-white',
          'text-gray-900',
          'placeholder:text-gray-400',
          'min-h-[48px] transition-shadow focus:ring-2'
        )}
        style={
          {
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          'absolute right-2 bottom-3 flex h-6 w-6 items-center justify-center rounded-full text-white transition-all',
